...
class graph
{
    function graph()
    {
         ...
         $this->y_label_style_size = -1;
         $this->y_label_style_colour = '#000000';
    ...
    {
        $this->y_label_style_size = $size;

        if( strlen( $colour ) > 0 )
                $this->y_label_style_colour = $colour;
    ...
    function render()
    {
        ...
        if( $this->y_label_style_size > 0 )
        {
            $tmp .= "&y_label_style=";
            $tmp .= $this->y_label_style_size .',';
            $tmp .= $this->y_label_style_colour;
            $tmp .= "&\r\n";
        }
